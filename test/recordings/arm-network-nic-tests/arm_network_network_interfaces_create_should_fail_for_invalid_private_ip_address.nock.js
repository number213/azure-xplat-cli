...
nock('http://management.azure.com:443')
  ...
  'x-ms-request-id': '2e90a0f6-0581-4ba9-839d-37d47e073692',
  'x-ms-correlation-request-id': '2e90a0f6-0581-4ba9-839d-37d47e073692',
  'x-ms-routing-request-id': 'WESTEUROPE:20170602T140822Z:2e90a0f6-0581-4ba9-839d-37d47e073692',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  date: 'Fri, 02 Jun 2017 14:08:21 GMT',
  connection: 'close',
  'content-length': '181' });
 return result; },
function (nock) { 
...
nock('http://management.azure.com:443')
  ...
  expires: '-1',
  etag: 'W/"024f13b1-5542-41af-b172-35dcb05192f0"',
  'x-ms-request-id': '5ba0eed8-2b1c-46f6-bf54-7d1dcbf4c378',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  server: 'Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14928',
  'x-ms-correlation-request-id': 'c09212ef-c589-48b0-898e-9ff9d6273812',
  'x-ms-routing-request-id': 'WESTEUROPE:20170602T140823Z:c09212ef-c589-48b0-898e-9ff9d6273812',
  date: 'Fri, 02 Jun 2017 14:08:23 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
nock('http://management.azure.com:443')
  ...
  expires: '-1',
  etag: 'W/"7b7d3d54-80c0-406f-b215-28ea338f6b6a"',
  'x-ms-request-id': 'e5871fbe-96a8-4395-864f-50e8785fbc7f',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  server: 'Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14874',
  'x-ms-correlation-request-id': '38460355-100c-4532-9690-01de3bcb2351',
  'x-ms-routing-request-id': 'WESTEUROPE:20170602T140824Z:38460355-100c-4532-9690-01de3bcb2351',
  date: 'Fri, 02 Jun 2017 14:08:23 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
...
.put('/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/resourceGroups/xplat-test-nic/providers/Microsoft.Network/networkInterfaces/InvalidPrivateIPAddressName?api-version=2017-03-01', '*')
  ...
  'content-type': 'application/json; charset=utf-8',
  expires: '-1',
  'x-ms-request-id': '09d6410b-ec9a-44d3-adb0-b2467097e92b',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  server: 'Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-writes': '1198',
  'x-ms-correlation-request-id': 'a3c19b92-ba29-44ce-814b-58c450454ffe',
  'x-ms-routing-request-id': 'WESTEUROPE:20170602T140827Z:a3c19b92-ba29-44ce-814b-58c450454ffe',
  date: 'Fri, 02 Jun 2017 14:08:26 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
