...
exports.init = function (cli) {
  ...
  iotHub.command('create [resource-group] [name] [location] [sku-name] [units]')
    ...
    .option('-c --c2d-ttl [c2dTtl]', $('The amount of time for which a cloud-to-device message is available for the device to consume before it is expired by IoT Hub. Range : [1-48 hours]. Default : 1 hour.'))
    .option('-f --feedback-lock-duration [feedbackLockDuration]', $('The lock duration in seconds for the feedback messages. Range : [5 seconds - 5 minutes]. Default : 1 minute.'))
    .option('-F --feedback-ttl [feedbackTtl]', $('The amount of time a feedback message is available for a backend service to consume before it is expired by Iot Hub. Range : [1-48 hours]. Default : 1 hour.'))
